...
Config.Blip = true -- Blip on Map
Config.RentalPlateMark = "nv" -- This is a Prefix for the Plate of the Vehicle
...
Config.rentalTimes = {
    { value = 1, text = '1 Dakika', fees = 100 },
    { value = 5, text = '5 Dakika', fees = 250 },
    { value = 10, text = '10 Dakika', fees = 380 },
    { value = 15, text = '15 Dakika', fees = 400 },
    { value = 25, text = '25 Dakika', fees = 550 },
}
